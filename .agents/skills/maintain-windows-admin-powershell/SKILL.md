...
Maintain this PowerShell 7 branch with a manager-pattern workflow that starts from the canonical script tree, validates WhatIf-safe behavior locally and in GitHub Actions, and records lasting repo knowledge in `AGENTS.md` and `docs/*`.
